...
\begin{enumerate} [(a)]
    ...
    \begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black]
      Define these two types of metric errors and how to measure them:
    \end{tcolorbox}
    % ?????????
    ...
    \item \textbf{[4 points]} 
    \begin{tcolorbox}[colback=orange!5!white,colframe=orange!75!black]
     Define these terms in the context of evaluating a classifier. How would you measure each one?:
    \end{tcolorbox}
